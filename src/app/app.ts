...
@Component({
  ...
  template: `
    <div
      class="relative min-h-screen w-full flex flex-col font-sans text-ui-dark  overflow-x-hidden transition-opacity duration-600 ease-in-out selection:bg-ui-green selection:text-ui-base"
